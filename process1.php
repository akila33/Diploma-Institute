...
if(isset($_POST['submitted'])){
    ...
    $sql="SELECT student_login.StdNumber, student.StdName, student.Address, student.Past_Performance
    FROM student_login
    INNER JOIN student ON student_login.StdNumber=student.StdNumber
    WHERE student_login.StdNumber='$StdNumberx' and student_login.Password='$Passwordx'";
    ...
    echo "<table>";
    echo "<tr><th>Student Number</th><th>Student Name</th><th>Address</th><th>Past_Performance</th></tr>";

    while ($row = mysqli_fetch_array($result,MYSQLI_ASSOC)){
        echo '<tr><td align = "center">'.$row['StdNumber'].'</td><td align = "center">'.$row['StdName'].'</td><td align = "center">'.$row['Address'].'</td><td align = "center">'.$row['Past_Performance'].'</td></tr>';
