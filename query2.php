...
if(isset($_POST['submitted'])){
    ...
    $sql1="UPDATE student SET StdName = 'Amal', Address = 'Ampara' WHERE StdNumber = 'S005'";
    $result1 =mysqli_query($dbcon, $sql1) or die(" error getting data".mysqli_error($dbcon));

    $sql="SELECT * FROM student WHERE StdNumber = 'S005'";
    ...
    echo "<table>";
    echo "<tr><th>StdNumber</th><th>StdName</th><th>Address</th><th>Past_Performance</th></tr>";
